...
export function db() {
  ...
  connection.exec(`
    ...
    CREATE TABLE IF NOT EXISTS schools (id TEXT PRIMARY KEY, name TEXT NOT NULL, code TEXT NOT NULL DEFAULT '', npsn TEXT NOT NULL DEFAULT '', address TEXT NOT NULL DEFAULT '', email TEXT NOT NULL DEFAULT '', phone TEXT NOT NULL DEFAULT '', logo_url TEXT NOT NULL DEFAULT '', principal_name TEXT NOT NULL DEFAULT '', principal_nip TEXT NOT NULL DEFAULT '', principal_signature_url TEXT NOT NULL DEFAULT '', timezone TEXT NOT NULL DEFAULT 'Asia/Jakarta', checkin_late_after TEXT NOT NULL DEFAULT '07:15', schedule_weekdays TEXT NOT NULL DEFAULT '[1,2,3,4,5]', education_level TEXT NOT NULL DEFAULT '', onboarding_completed_at TEXT, is_active INTEGER NOT NULL DEFAULT 1, created_at TEXT NOT NULL DEFAULT (datetime('now')), updated_at TEXT NOT NULL DEFAULT (datetime('now')));
